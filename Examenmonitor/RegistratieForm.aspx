                ...
                <asp:Table class="FormTables" ID="Table1" runat="server" CellPadding="5"
                    ...
                    <asp:TableRow BorderColor="Transparent">
                        ...
                        <asp:TableCell BorderColor="Transparent">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" EnableClientScript="false" ControlToValidate="Voornaam"
                                    CssClass="field-validation-error" ErrorMessage="Voornaam is een verplicht veld" />
                                <%-- Regex validator --%>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorVoorNaam" EnableClientScript="false" runat="server" ControlToValidate="Voornaam" 
                    ...
                    <asp:TableRow BorderColor="Transparent">
                        ...
                        <asp:TableCell BorderColor="Transparent">
                                ...
                                <%-- Validator om te zien of het veld is ingevuld --%>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorAchterNaam" EnableClientScript="false" runat="server" ControlToValidate="AchterNaam" 
                                    CssClass="field-validation-error" Display="Dynamic" 
                                    ErrorMessage="Achternaam is een verplicht veld!"></asp:RequiredFieldValidator>
                                <%-- Regex validator --%>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorAchternaam" EnableClientScript="false" runat="server" 
                    ...
                    <asp:TableRow BorderColor="Transparent">
                        ...
                        <asp:TableCell BorderColor="Transparent">
                                ...
                                <%-- Validator om te zien of het veld is ingevuld --%>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" EnableClientScript="false" runat="server" ControlToValidate="Email"
                    ...
                    <asp:TableRow BorderColor="Transparent">
                        ...
                        <asp:TableCell BorderColor="Transparent">
                                ...
                                <%-- Validator om te zien of het veld is ingevuld--%>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" EnableClientScript="false" runat="server" ControlToValidate="Password"
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorWachtwoord" EnableClientScript="false" runat="server" 
                    ...
                    <asp:TableRow BorderColor="Transparent">
                        ...
                        <asp:TableCell BorderColor="Transparent">
                                ...
                                <%-- Validator om te zien of het veld is ingevuld --%>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" EnableClientScript="false" ControlToValidate="ConfirmPassword"
                                ...
                                <asp:CompareValidator ID="CompareValidator1" runat="server" EnableClientScript="false" ControlToCompare="Password" ControlToValidate="ConfirmPassword"
