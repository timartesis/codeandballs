...
namespace Examenmonitor
{
    public class Validatie
    {
        ...
        //Reguliere expressies die het patroon van een email, gebruikersnaam en wachtwoord zullen controleren om te zien of deze juist zijn,
        ...
        private static Regex expressieWachtwoord = new Regex(wachtwoordPatroon, RegexOptions.Compiled);
